...
<head>
    ...
    <title>Cake Store - Contact</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-4">
                    <p>Phone:
                        <strong>071-1234567</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:madushikaranapana113@gmail.com">madushikaranapana113@gmail.com</a></strong>
                    </p>
                    <p>Address:<br>
                        <strong>University of Kelaniya
                            <br>Kelaniya</strong>
                    </p>
                </div>
